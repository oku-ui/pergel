...
import type { GraphqlYogaContext } from '#changeName/server/graphqlYoga/types';
...
export type RoleStatusResolvers = EnumResolverSignature<{ user?: any, admin?: any, superadmin?: any }, ResolversTypes['RoleStatus']>;
