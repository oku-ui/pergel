...
// import Input from '#pergel/ui/atom/input.vue'
// import {
//   FormControl,
//   FormDescription,
//   FormField,
...
<template>
  <div class="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
      <img class="mx-auto h-10 w-auto" src="https://raw.githubusercontent.com/oku-ui/static/main/logo/logo-dark.svg" alt="Your Company">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
      ...
      <p class="mt-10 text-center text-sm text-gray-500">
        Not a member?
        <a href="#" class="font-semibold leading-6 text-green-600 hover:text-green-500">Start a 14 day free trial</a>
      </p>
    </div>
  </div>
</template>
