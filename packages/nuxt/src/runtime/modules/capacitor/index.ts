  ...
  async setup({ nuxt, options }) {
    ...
    generateProjectReadme({
      data: ({ addCommentBlock }) => ({
        ...
        cli: {
          'capacitor:init': `pergel module -s=capacitor:init -p=${projectName} -m=${moduleName}`,
          'capacitor:sync': `pergel module -s=capacitor:sync -p=${projectName} -m=${moduleName}`,
          'capacitor:android': `pergel module -s=capacitor:android -p=${projectName} -m=${moduleName}`,
          'capacitor:ios': `pergel module -s=capacitor:ios -p=${projectName} -m=${moduleName}`,
